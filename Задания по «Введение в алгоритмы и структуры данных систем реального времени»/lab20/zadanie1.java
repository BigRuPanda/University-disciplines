...
public class zadanie1<T, V, K> {
    ...
    public void printClassNames() {
        System.out.println("Классы переменных: ");
        System.out.println("Тип переменной T: " + varT.getClass().getName());
        System.out.println("Тип переменной V: " + varV.getClass().getName());
        System.out.println("Тип переменной K: " + varK.getClass().getName());
    }
